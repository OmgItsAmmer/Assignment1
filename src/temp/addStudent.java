...
public class addStudent extends javax.swing.JFrame {
    ...
    public addStudent(ArrayList<user> user_arr,ArrayList<book> book_arr ) {
        initComponents();
        this.Book_array = book_arr;
        this.User_array = user_arr;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            jLabel6.setText("Invalid book id");
        }
        try {
            int temp2 = Integer.parseInt(jTextField4.getText());
        } catch (Exception e) {
            jLabel6.setText("Invalid Borrowed books");
        }
        ...
        int Borrowedbooks = Integer.parseInt(jTextField4.getText());
